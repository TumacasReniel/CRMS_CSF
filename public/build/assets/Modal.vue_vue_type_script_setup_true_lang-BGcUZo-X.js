import{s as S}from"./vue-multiselect.css_vue_type_style_index_0_src_true_lang-Cmmqp9YJ.js";import j from"./ByUnitMonthly-BfJYfdMD.js";import{P as A}from"./index-DajnbktX.js";import{z as M,d as g,i as U,x as z,j as t,o as y,e as D,b as e,w as o,g as c,t as F,u as T,a as r,c as $,f as q,F as E}from"./app-C0PQ6YLl.js";const I=r("span",{class:"text-h5"},"Select Assignatoree",-1),G=r("label",null,"Prepared By:",-1),H=r("label",null,"Noted By:",-1),J={style:{"text-align":"end"}},X=M({__name:"Modal",props:{form:{type:Object,default:null},assignatorees:{type:Object,default:null},user:{type:Object,default:null},value:{type:Boolean,default:!1},data:{type:Boolean},generated:{type:Boolean}},emits:["input"],setup(n,{emit:b}){const p=b,m=n,i=g(!1);U(()=>m.value,l=>{i.value=l});const d=z({prepared_by:m.user,noted_by:{}}),w=l=>{p("input",l)},x=g(!1),h=async()=>{x.value=!0,(await new A).print(document.querySelector(".print-id"),[` 
