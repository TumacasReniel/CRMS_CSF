import{s as S}from"./vue-multiselect.css_vue_type_style_index_0_src_true_lang-Dnn8HC51.js";import j from"./ByUnitMonthly-BYg-d2U8.js";import{P as A}from"./index-DajnbktX.js";import{z as M,d as g,i as U,x as z,j as t,o as y,e as D,b as e,w as o,g as c,t as F,u as T,a as r,c as $,f as q,F as E}from"./app-D8es4Nph.js";const I=r("span",{class:"text-h5"},"Select Assignatoree",-1),G=r("label",null,"Prepared By:",-1),H=r("label",null,"Noted By:",-1),J={style:{"text-align":"end"}},X=M({__name:"Modal",props:{form:{type:Object,default:null},assignatorees:{type:Object,default:null},user:{type:Object,default:null},value:{type:Boolean,default:!1},data:{type:Boolean},generated:{type:Boolean}},emits:["input"],setup(n,{emit:b}){const p=b,m=n,i=g(!1);U(()=>m.value,l=>{i.value=l});const d=z({prepared_by:m.user,noted_by:{}}),w=l=>{p("input",l)},x=g(!1),h=async()=>{x.value=!0,(await new A).print(document.querySelector(".print-id"),[` 
        ...
        `]),p("input",!1)};return(l,a)=>{const k=t("v-card-title"),B=t("v-text-field"),u=t("v-col"),_=t("v-row"),V=t("v-card-text"),C=t("v-spacer"),N=t("v-divider"),f=t("v-icon"),v=t("v-btn"),O=t("v-card-action"),P=t("v-card"),R=t("v-dialog");return y(),D(E,null,[e(R,{modelValue:i.value,"onUpdate:modelValue":a[3]||(a[3]=s=>i.value=s),width:"600",scrollable:"",persistent:""},{default:o(()=>[e(P,null,{default:o(()=>[e(k,{class:"bg-indigo"},{default:o(()=>[I]),_:1}),e(V,null,{default:o(()=>[e(_,{style:{"margin-bottom":"-30px"}},{default:o(()=>[e(u,null,{default:o(()=>[G,e(B,{size:"small",variant:"text",readonly:""},{default:o(()=>[c(F(n.user.name),1)]),_:1})]),_:1})]),_:1}),e(_,{style:{"margin-top":"-50px"}},{default:o(()=>[e(u,null,{default:o(()=>[H,e(T(S),{modelValue:d.noted_by,"onUpdate:modelValue":a[0]||(a[0]=s=>d.noted_by=s),options:n.assignatorees,multiple:!1,placeholder:"Noted By:",label:"name","track-by":"name","allow-empty":!1,class:"ml-5"},null,8,["modelValue","options"])]),_:1})]),_:1})]),_:1}),e(C),e(O,null,{default:o(()=>[e(N),r("div",J,[e(v,{class:"ma-2",color:"blue-grey-lighten-2",onClick:a[1]||(a[1]=s=>w(!1))},{default:o(()=>[e(f,{start:"",icon:"mdi-cancel"}),c(" Cancel ")]),_:1}),e(v,{class:"ma-2",color:"green-darken-1",type:"button",onClick:a[2]||(a[2]=s=>h())},{default:o(()=>[c(" Print Preview "),e(f,{end:"",icon:"mdi-print"})]),_:1})])]),_:1})]),_:1})]),_:1},8,["modelValue"]),n.form.csi_type=="By Month"?(y(),$(j,{key:0,form:n.form,data:n.data,form_assignatorees:d},null,8,["form","data","form_assignatorees"])):q("",!0)],64)}}});export{X as _};
