            ...
            <div style="font-size: 12px;">
             ...
             <div style="font-size: 12px">  
                Services Unit : <u v-if="data.unit.data.length > 0">{{ data.unit.data[0].unit_name }}</u><br>
                                <u v-if="form.selected_unit_psto" style="margin-left: 70px">{{ form.selected_unit_psto.psto_name }}</u><br v-if="form.selected_unit_psto.length > 0">
                                <u v-if="data.sub_unit[0]" style="margin-left: 75px">{{ data.sub_unit[0].sub_unit_name }}</u><br v-if="form.client_type">
                                ...
                                <u v-if="form.selected_sub_unit_psto">{{ form.selected_sub_unit_psto.psto_name }}</u>
            </div>
        </div>
