                 ...
                 <table style="font-size: 13px;width:100%; border: 1px solid #333; border-collapse: collapse;  padding: 3px">
                    ...
                    <tr>
                        <td colspan="3" class="text-right">% of Promoters:</td>
                         <td class="text-center" >
                            <span v-if="jul_percentage_promoters > 0">
                                {{ jul_percentage_promoters }}
                            </span>
                        </td>  
                        <td class="text-center " >
                            <span v-if="aug_percentage_promoters > 0">
                                {{ aug_percentage_promoters }}
                            </span>
                        </td>
                        <td  class="text-center" >
                            <span v-if="sep_percentage_promoters > 0">
                                {{ sep_percentage_promoters }}
                            </span>
                        </td>
                        <td colspan="2"  class="text-center">
                            <span v-if="average_percentage_promoters > 0">
                                {{ average_percentage_promoters }}
                            </span>
                        </td>
                    ...
                    <tr>
                        ...
                        <td class="text-center" >
                            <span v-if="jul_percentage_detractors > 0">
                                {{ jul_percentage_detractors }}
                            </span>
                        </td>  
                        <td  class="text-center " >
                            <span v-if="aug_percentage_detractors > 0">
                                {{ aug_percentage_detractors }}
                            </span>
                        </td>
                        <td class="text-center" >
                            <span v-if="sep_percentage_detractors > 0">
                                {{ sep_percentage_detractors }}
                            </span>
                        </td>
                        <td  colspan="2"  class="text-center">
                            <span v-if="average_percentage_detractors > 0">
                                {{ average_percentage_detractors }}
                            </span>
                        </td>
                    ...
                    <tr>
                        ...
                        <td  class="text-center" >
                            <span v-if="jul_net_promoter_score > 0">
                                {{ jul_net_promoter_score }}
                            </span>
                        </td>  
                        <td  class="text-center " >
                            <span v-if="aug_percentage_detractors > 0">
                        ...
                        <td  class="text-center" >
                            <span v-if="sep_net_promoter_score > 0">
                                {{ sep_net_promoter_score }}
                            </span>
                        </td>
                        <td  colspan="2"  class="text-center">
                            <span v-if="ave_net_promoter_score > 0">
                                {{ ave_net_promoter_score }}
                            </span>
                        </td>
                    </tr>
                    <tr>
