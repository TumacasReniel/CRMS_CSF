                ...
                <div style="margin-top: 20px; page-break-before:always">
                        ...
                        <table style="font-size: 13px;width:100%; border: 1px solid #333; border-collapse: collapse;  padding: 3px">
                            ...
                            <tr>
                                ...
                                <td class="text-center" >
                                    <span v-if="data.jan_percentage_promoters > 0">
                                        {{ data.jan_percentage_promoters }}
                                    </span> 
                                </td>  
                                <td class="text-center " >
                                    <span v-if="data.feb_percentage_promoters > 0">
                                        {{ data.feb_percentage_promoters }}
                                    </span> 
                                </td>
                                <td v-if="data.jan_percentage_promoters" class="text-center" >
                                    <span v-if="data.mar_percentage_promoters > 0">
                            ...
                            <tr>
                                ...
                                <td class="text-center" >
                                    <span v-if="data.jan_percentage_detractors > 0">
                                        {{ data.jan_percentage_detractors }}
                                    </span> 
                                </td>  
                                <td  class="text-center " >
                                    <span v-if="data.feb_percentage_detractors > 0">
                                        {{ data.feb_percentage_detractors }}
                                    </span> 
                                </td>
                                <td  class="text-center" >
                                    <span v-if="data.mar_percentage_detractors > 0">
                            ...
                            <tr>
                                ...
                                <td  class="text-center" >
                                    <span v-if=" data.jan_net_promoter_score > 0">
                                ...
                                <td  class="text-center" >
                                    <span v-if=" data.mar_net_promoter_score > 0">
                            ...
                            <tr>
                               <td colspan="3" class="text-right">Customer Satisfaction Index (CSI):</td>
                                <td class="text-center" v-if="data.first_month_csi">
                ...
                <div style="margin-top: 5px ; font-size: 13px">
                    ...
                    <div  style="text-align: justify; margin: 5px">
                      ...
                      <span>{{ data.total_respondents }}</span><span>{{ data.total_respondents }}</span>, or <span>{{ data.percentage_vss_respondents }}</span>%) of the respondents rated the CSF as either very satisfied (VS) or satisfied (S), 
                        which resulted in an overall average Customer Satisfaction Index (CSI) of <span>{{ data.csi }}</span><span>{{ data.total_respondents }}</span>, 
