        ...
        <table class="w-full border ">
            ...
            <tr>
                ...
                <td class="text-center" >
                    <span v-if="data.apr_total_vs_respondents > 0">{{ data.apr_total_vs_respondents }}</span> 
                </td>
                <td class="text-center"> 
                    <span v-if="data.may_total_vs_respondents > 0">{{ data.may_total_vs_respondents }}</span> 
                </td>
                <td class="text-center">
                    <span v-if="data.jun_total_vs_respondents > 0">{{ data.jun_total_vs_respondents }}</span> 
                </td>
                <td class="text-center">
                    <span v-if="data.vs_grand_total_raw_points > 0">{{ data.vs_grand_total_raw_points }}</span> 
                </td>
                <td class="text-center">
                    <span v-if="data.vs_grand_total_score > 0">{{ data.vs_grand_total_score }}</span> 
                </td>
                <td class="text-center">
