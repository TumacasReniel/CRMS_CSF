        ...
        <table class="w-full border ">
            ...
            <tr>
                ...
                <td class="text-center">
                    <span v-if="data.apr_vs_grand_total > 0">
                        {{ data.apr_vs_grand_total }}
                    </span>
                </td>
                <td class="text-center"> 
                    <span v-if="data.may_vs_grand_total  > 0">
                        {{ data.may_vs_grand_total  }}
                    </span>
                </td>
                <td class="text-center">
                    <span v-if="data.jun_vs_grand_total   > 0">
                        {{ data.jun_vs_grand_total   }}
                    </span>
                 </td>
                <td class="text-center">
            ...
            <tr>
                ...
                <td class="text-center">
                    <span v-if="data.apr_s_grand_total  > 0">
                        {{ data.apr_s_grand_total   }}
                    </span>
                </td>
                <td class="text-center"> 
                    <span v-if="data.may_s_grand_total  > 0">
                        {{ data.may_s_grand_total   }}
                    </span>
                </td>
                <td class="text-center">
                    <span v-if="data.jun_s_grand_total  > 0">
                        {{ data.jun_s_grand_total   }}
                    </span>
                </td>
                <td class="text-center">
        ...
        <v-card-title class="bg-gray-500 text-white">
            ...
            <tr>
                ...
                <td v-if="data.apr_net_promoter_score" class="text-center" >
                    <span v-if="data.apr_net_promoter_score > 0">
                ...
                <td v-if="data.jun_net_promoter_score" class="text-center" >
                    <span v-if="data.jun_net_promoter_score > 0">
    ...
    <v-card class="mb-3">
        ...
        <v-card-content class="m-5 mb-10">
                ...
                <v-chip color="primary">
                    <span v-if="data.total_comments > 0">
                        {{ data.total_comments }}
                    </span>   
                </v-chip>
                </div>
