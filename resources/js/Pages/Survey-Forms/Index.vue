...
<template>
    ...
    <v-form class="max-w" @submit.prevent="saveCSF">
        <div class="py-20 bg-gray-200 mx-auto">
            <v-card class="mb-5"  style="margin-left: 250px; margin-right: 250px;">
            ...
            <v-card 
                ...
                <div>
                    ...
                    >
                        ...
                        <div class="ml-2 mb-3">
                            <v-btn-toggle v-model="form.reliability"  v-for="option in options" :key="option.value" >
                    ...
                    >
                        ...
                        <div class="ml-2 mb-3">
                            <v-btn-toggle v-model="form.access_and_facilities"  v-for="option in options" :key="option.value" >
                                <v-btn class="bg-secondary mr-2" :value="option.value" >
                    ...
                    >
                        ...
                        <div class="ml-2 mb-3">
                            <v-btn-toggle v-model="form.communication"  v-for="option in options" :key="option.value" >
                                <v-btn class="bg-secondary mr-2" :value="option.value" >
                    ...
                    >
                        ...
                        <div class="ml-2 mb-3">
                            <v-btn-toggle v-model="form.integrity"  v-for="option in options" :key="option.value" >
                                <v-btn class="bg-secondary mr-2" :value="option.value" >
                    ...
                    >
                        ...
                        <div class="ml-2 mb-3">
                            <v-btn-toggle v-model="form.assurance"  v-for="option in options" :key="option.value" >
                                <v-btn class="bg-secondary mr-2" :value="option.value" >
                    ...
                    >
                        ...
                        <div class="ml-2 mb-3">
                            <v-btn-toggle v-model="form.outcome"  v-for="option in options" :key="option.value" >
                                <v-btn class="bg-secondary mr-2" :value="option.value" >
