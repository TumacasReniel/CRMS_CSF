...
class ReportController extends Controller
{
    ...
    public function generateCSIByUnitFirstQuarter(Request $request)
    {
       ...
       $month_mar = [];
        ...
        $total_vs_respondents = $date_range->where('rate_score', '=','5')->groupBy('customer.id')->count();
        // total number of respondents/customer who rated S
        $total_s_respondents = $date_range->where('rate_score', '=','4')->groupBy('customer.id')->count();
    ...
    public function generateCSIByUnitSecondQuarter(Request $request)
    {
        ...
        // Total No. of Other (N, D, VD) Responses
        // -- April
        $apr_total_ndvd_respondents = $month_apr->where('rate_score',3)->groupBy('customer_id')->count();
        // -- May
        $may_total_ndvd_respondents = $month_may->where('rate_score',3)->groupBy('customer_id')->count();
        // -- June
        $jun_total_ndvd_respondents = $month_jun->where('rate_score',3)->groupBy('customer_id')->count();
    ...
    public function generateCSIByUnitThirdQuarter(Request $request)
    {
        ...
        // Total No. of Satisfied (S) Responses
       // -- July
       $jul_total_s_respondents = $month_jul->where('rate_score',5)->groupBy('customer_id')->count();
       // -- August
       $aug_total_s_respondents = $month_aug->where('rate_score',5)->groupBy('customer_id')->count();
       // -- September
       $sep_total_s_respondents = $month_sep->where('rate_score',5)->groupBy('customer_id')->count();

        // Total No. of Other (N, D, VD) Responses
        // -- July
        $jul_total_ndvd_respondents = $month_jul->where('rate_score',5)->groupBy('customer_id')->count();
        // -- August
        $aug_total_ndvd_respondents = $month_aug->where('rate_score',5)->groupBy('customer_id')->count();
        // -- September
        $sep_total_ndvd_respondents = $month_sep->where('rate_score',5)->groupBy('customer_id')->count();
    ...
    public function generateCSIByUnitFourthQuarter(Request $request)
    {
        ...
        // Total No. of Satisfied (S) Responses
       // -- October
       $oct_total_s_respondents = $month_oct->where('rate_score',5)->groupBy('customer_id')->count();
       // -- November
       $nov_total_s_respondents = $month_nov->where('rate_score',5)->groupBy('customer_id')->count();
       // -- December
       $dec_total_s_respondents = $month_dec->where('rate_score',5)->groupBy('customer_id')->count();

        // Total No. of Other (N, D, VD) Responses
       // -- October
       $oct_total_ndvd_respondents = $month_oct->where('rate_score',5)->groupBy('customer_id')->count();
       // -- November
       $nov_total_ndvd_respondents = $month_nov->where('rate_score',5)->groupBy('customer_id')->count();
       // -- December
       $dec_total_ndvd_respondents = $month_dec->where('rate_score',5)->groupBy('customer_id')->count();
    ...
    public function calculateCSI($wf_total, $ws_total, $ss_total){
        //   // WF = (importance LS Rating divided by importance grand total  of ls rating) * 100
        //   if($ilsr_total != 0){
        //     $wf_total =  ($ilsr_total / $ilsr_grand_total) * 100;
        // }
